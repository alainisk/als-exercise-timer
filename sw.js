const CACHE_NAME = 'als-timer-v9';
const ASSETS = ['./favicon.png?v=20260913-2', './index.html', './styles.css', './redesign.css?v=20260913', './app.js?v=20260913', './manifest.json', './icon-192.png', './icon-512.png'];
