...
(function(root){
  ...
  function parse(value) {
    ...
    if(id && /^[a-zA-Z0-9_-]{11}$/.test(id)) return {provider:'youtube',url:'https://www.youtube.com/watch?v='+id,embed:'https://www.youtube-nocookie.com/embed/'+id+'?playsinline=1&rel=0'};
    if(host === 'vimeo.com' || host === 'player.vimeo.com') {
      ...
      if(match) {
        ...
        return {provider:'vimeo',url:'https://vimeo.com/'+match[1]+(h?'/'+h:''),embed:'https://player.vimeo.com/video/'+match[1]+(h?'?h='+h:'')};
      }
    }
    return null;
  }
